...
export const MOCK_HOSTS: Host[] = [
  {
    ...
    vat: 7.7,
    businessName: 'Alpine Getaways',
    businessId: 'CH-123.456.789',
    landingPagePicture: 'https://images.unsplash.com/photo-1548777123-e216912df7d8?auto=format&fit=crop&q=80&w=1200',
  ...
  },
  {
    ...
    businessId: 'JP-1234567890',
    landingPagePicture: 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?auto=format&fit=crop&q=80&w=800&h=600',
    terms: 'Terms and conditions content',
    conditions: 'Conditions content',
    faq: 'FAQ content',
    premiumConfig: null,
  ...
  },
  {
    ...
    businessId: 'IT-12345678901',
    landingPagePicture: 'https://images.unsplash.com/photo-1523217582562-09d0def993a6?auto=format&fit=crop&q=80&w=800&h=600',
    terms: 'Terms and conditions content',
    conditions: 'Conditions content',
    faq: 'FAQ content',
    premiumConfig: null,
  ...
  },
  {
    ...
    businessId: 'US-12-3456789',
    landingPagePicture: 'https://images.unsplash.com/photo-1600596542815-ffad4d6cdb19?auto=format&fit=crop&q=80&w=800&h=600',
    terms: 'Terms and conditions content',
    conditions: 'Conditions content',
    faq: 'FAQ content',
    premiumConfig: null,
...
export const MOCK_APARTMENTS: Apartment[] = [
  {
    ...
    address: '123 Alpine Way, Grindelwald',
    city: 'Grindelwald',
    capacity: 4,
    bedrooms: 2,
    bathrooms: 2,
  ...
  },
  {
    ...
    address: '456 Eiger Trail, Grindelwald',
    city: 'Grindelwald',
    capacity: 2,
    bedrooms: 1,
    bathrooms: 1,
...
export const MOCK_BOOKINGS: Booking[] = [
  {
    ...
    guestCountry: 'USA',
    guestPhone: '555-1234',
    guestMessage: 'Looking forward to our stay!',
    numGuests: 2,
  ...
  },
  {
    ...
    guestCountry: 'Japan',
    guestPhone: '555-5678',
    guestMessage: 'Excited to visit Tokyo!',
    numGuests: 1,
  ...
  },
  {
    ...
    guestCountry: 'Italy',
    guestPhone: '555-9012',
    guestMessage: 'Bringing my family for a vacation.',
    numGuests: 4,
  ...
  },
  {
    ...
    guestCountry: 'UK',
    guestPhone: '555-3456',
    guestMessage: 'Hoping for good weather!',
    numGuests: 2,
  ...
  },
  {
    ...
    guestCountry: 'USA',
    guestPhone: '555-7890',
    guestMessage: 'Can\'t wait for the beach!',
    numGuests: 3,
