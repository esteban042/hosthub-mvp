...
const ApartmentDetails: React.FC<ApartmentDetailsProps> = ({ apt, onAptChange, onAmenitiesChange }) => {
  ...
  return (
    <div className="space-y-10">
        <div>
            <label className="block text-[10px] font-black uppercase tracking-widest text-charcoal/60 mb-3">{t('host_dashboard.apartment_editor.apartment_details.description')}</label>
        ...
        <div className="pt-8 border-t border-stone-200">
            <h4 className="text-lg sm:text-xl font-bold text-charcoal tracking-tight mb-8">{t('host_dashboard.apartment_editor.apartment_details.amenities')}</h4>
            <AmenitySelector
