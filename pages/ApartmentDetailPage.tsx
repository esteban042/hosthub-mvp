...
const ApartmentDetailPage: React.FC<ApartmentDetailPageProps> = ({
  ...
  const totalPrice = useMemo(() => {
    ...
    // Loop inclusive of start date, exclusive of end date (standard booking logic for nights)
    ...
    <div className="pt-24 md:pt-32 pb-24 w-full max-w-7xl mx-auto px-6 text-left animate-in fade-in duration-700 font-dm">
      ...
      <div className="grid grid-cols-1 gap-16">
        <div className="space-y-16">
          ...
          {/* MOVED BOOKING FORM SECTION */}
          <div className="bg-stone-900/40 backdrop-blur-3xl p-10 rounded-[2.5rem] border border-stone-800 shadow-2xl max-w-2xl mx-auto">
